<?php include('depdataphp.php')?> <!-- check db connection & query all data from dept. table -->
<!DOCTYPE html>
<html lang="en">
...
<nav class="w3-sidebar w3-aqua w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <dt><a href="department.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white  w3-red">Department</a> </dt>
          <dd></dd>
